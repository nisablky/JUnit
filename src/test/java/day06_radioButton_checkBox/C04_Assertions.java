...
public class C04_Assertions {
    ...
    public void test01(){
        /*
        Eger test method'umuzda hiçbir tst yoksa, test calistiktan sonra
        hic bir problemle karsilasilmadigini raporlamak icin "tests passed" yazisi cikar

        Eger testleri if ile yaparsak
        test failed olsa bile kodlar problemsiz calisigi icin
        kod calismasi bittiginde
        ekranın sol alt kisminda test passed yazacaktir
         */
    ...
    */
        ...
        /*
        Assert ile yaptigimiz testlerde assetion failed olursa
